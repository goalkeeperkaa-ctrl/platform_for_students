...
> = {
  'client-sever': {
    ...
    about: 'Небольшая сеть спешелти-кофеен в центре Москвы. Обучаем бариста с нуля и растим управляющих из своих сотрудников.',
...
export const INSTITUTIONS: Array<{
...
}> = [
  {
    ...
    shortName: 'НИУ ВШЭ',
    city: 'Москва',
    description: 'Исследовательский университет: экономика, менеджмент, анализ данных, право, медиа и дизайн.',
    directions: ['Экономика', 'Менеджмент', 'Анализ данных', 'Право', 'Медиакоммуникации', 'Дизайн'],
  ...
  },
  {
    ...
    city: 'Москва',
    description: 'Технический университет: инженерия, информатика, робототехника и приборостроение.',
    directions: ['Информатика и вычислительная техника', 'Робототехника', 'Машиностроение', 'Приборостроение'],
  ...
  },
  {
    ...
    city: 'Москва',
    description: 'Экономический университет: маркетинг, торговля, финансы, гостеприимство и управление.',
    directions: ['Маркетинг', 'Финансы', 'Торговое дело', 'Гостиничное дело', 'Менеджмент'],
  ...
  },
  {
    ...
    shortName: 'МГУ',
    city: 'Москва',
    description: 'Классический университет с естественно-научными, гуманитарными и социальными направлениями.',
    directions: ['Математика и механика', 'Физика', 'Экономика', 'Журналистика', 'Психология'],
  ...
  },
  {
    ...
    shortName: 'МФТИ',
    city: 'Долгопрудный',
    description: 'Физика, математика и информатика; обучение построено вокруг исследовательских лабораторий.',
    directions: ['Прикладная математика и физика', 'Информатика', 'Биотехнологии', 'Аэрокосмические технологии'],
  ...
  },
  {
    ...
    shortName: 'РГГУ',
    city: 'Москва',
    description: 'Гуманитарный университет: история, филология, журналистика, психология и реклама.',
    directions: ['Журналистика', 'История', 'Филология', 'Психология', 'Реклама и связи с общественностью'],
  ...
  },
  {
    ...
    shortName: 'МИСИС',
    city: 'Москва',
    description: 'Технологический университет: материаловедение, металлургия, горное дело и IT.',
    directions: ['Материаловедение', 'Металлургия', 'Горное дело', 'Информационные технологии'],
  ...
  },
  {
    ...
    shortName: 'РАНХиГС',
    city: 'Москва',
    description: 'Управление, экономика, право и государственная служба.',
    directions: ['Государственное управление', 'Экономика', 'Юриспруденция', 'Менеджмент'],
  ...
  },
  {
    ...
    city: 'Москва',
    description: 'Финансы, экономика, налоги, аудит и бизнес-информатика.',
    directions: ['Финансы и кредит', 'Экономика', 'Бизнес-информатика', 'Аудит'],
  ...
  },
  {
    ...
    shortName: 'МГИМО',
    city: 'Москва',
    description: 'Международные отношения, экономика, право и иностранные языки.',
    directions: ['Международные отношения', 'Мировая экономика', 'Международное право', 'Журналистика'],
  ...
  },
  {
    ...
    description: 'Классический университет: естественные науки, право, экономика, международные отношения и языки.',
    directions: ['Юриспруденция', 'Экономика', 'Международные отношения', 'Прикладная математика', 'Филология'],
  ...
  },
  {
    ...
    shortName: 'ИТМО',
    city: 'Санкт-Петербург',
    description: 'IT, фотоника, робототехника и цифровые технологии.',
    directions: ['Программирование', 'Фотоника', 'Робототехника', 'Цифровой дизайн'],
  ...
  },
  {
    ...
    shortName: 'КФУ',
    city: 'Казань',
    description: 'Федеральный университет: естественные науки, IT, медицина и гуманитарные направления.',
    directions: ['Информационные технологии', 'Медицина', 'Экономика', 'Филология', 'Педагогика'],
  ...
  },
  {
    ...
    shortName: 'УрФУ',
    city: 'Екатеринбург',
    description: 'Инженерия, IT, экономика и гуманитарные направления.',
    directions: ['Инженерия', 'Информационные технологии', 'Экономика', 'Строительство'],
  ...
  },
  {
    ...
    shortName: 'НГУ',
    city: 'Новосибирск',
    description: 'Естественные науки, математика и IT; тесная связь с институтами Академгородка.',
    directions: ['Математика', 'Физика', 'Информационные технологии', 'Биология'],
